    ...
    100: function(e, t, n) {
        ...
        window.isEditMode = !1, window.ea = {
            ...
            elementStatusCheck: function(e) {
                return !(!window.eaElementList || !(e in window.eaElementList)) || (window.eaElementList = v(v({}, window.eaElementList), {}, g({}, e, !0)), !1)
            }
        }, b();
        var w, j = !1;
        window.addEventListener("resize", (function() {
            ...
            })), w = jQuery, ea.getToken = function() {
                localize.nonce && !ea.noncegenerated && w.ajax({
                    url: localize.ajaxurl,
                    type: "post",
                    data: {
            ...
            }, w("a").on("click", (function(e) {
                var t, n = w(this).attr("href");
                (t = (n = void 0 === n ? "" : n).startsWith("#")) || (t = (n = n.replace(localize.page_permalink, "")).startsWith("#"));
                try {
                    if (t && (w(n).hasClass("eael-tab-item-trigger") || w(n).hasClass("eael-accordion-header")) && (w(n).trigger("click"), void 0 !== n && n)) {
                        var r = w(n).closest(".eael-advance-tabs").data("custom-id-offset");
                        r = r ? parseFloat(r) : 0, w("html, body").animate({
                            scrollTop: w(n).offset().top - r
                        }, 300)
                    }
                } catch (e) {}
            })),
